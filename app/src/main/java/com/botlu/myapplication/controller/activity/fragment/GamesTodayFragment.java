 ...
 * Use the {@link GamesTodayFragment#newInstance} factory method to
...
public class GamesTodayFragment extends Fragment {
     ...
     * @return A new instance of fragment GamesTodayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GamesTodayFragment newInstance(String param1, String param2) {
        GamesTodayFragment fragment = new GamesTodayFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.games_today_recycler);
        cardView = view.findViewById(R.id.card_no_result);

        LinearLayoutManager llm = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(llm);
        List<GamesModel> gamesModels = globalController.retrieveCurrentGames();
